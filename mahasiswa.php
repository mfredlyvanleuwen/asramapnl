                ...
                <table class="table align-items-center mb-0 " id="myTable">
                  <thead>
                    <tr>
                      ...
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">NIK/NIM</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">TTL</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">JK</th>
                      ...
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Kabupaten</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Kecamatan</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Alamat</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Orang Tua / Wali</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">No Telp Orang Tua / Wali</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Alamat Orang Tua / Wali</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Pendidikan Terakhir</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Sekolah</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Jurusan</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Prodi</th>
                      <th class="text-uppercase text-dark text-xxs font-weight-bolder">Semester</th>
